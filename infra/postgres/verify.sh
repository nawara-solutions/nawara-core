...
for svc in billing payment accounting organization notification file audit release; do
  ...
  for other in billing payment accounting organization notification file audit release; do
    [ "$other" = "$svc" ] && continue
