...
| [0049](./0049-audit-trail-architecture.md) | Security and business audit trail: producer-owned cataloged audit events through the transactional outbox, append-only records, tenant-safe query | Accepted (2026-09-25, Stage 18.1) |
