...
| [audit-service](./audit-service.md) | Draft (Stage 18.1 design); foundation (18.2), persistence (18.3), contract and catalog (18.4), RabbitMQ ingestion (18.5), query and authorization (18.6) |
