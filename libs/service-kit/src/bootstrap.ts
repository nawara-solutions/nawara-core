 ...
 *   request/correlation ids -> secure headers -> bounded JSON body -> DTO whitelist (unknown fields are rejected)
 *   -> uniform error filter -> structured logger -> graceful shutdown hooks. CORS stays off unless exact origins are listed.
 */
