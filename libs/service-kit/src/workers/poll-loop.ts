 ...
 * A pass that throws is reported through `onError` and the next one runs as scheduled.
 */
export class PollLoop {
  ...
  /** Stops scheduling, then waits for the running pass, bounded. Never throws: the outcome says what happened. */
