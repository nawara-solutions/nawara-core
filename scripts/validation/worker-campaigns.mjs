...
const { ExpirySweeper, WEBHOOK_RETRY_MAX_ATTEMPTS, kit, paymentWorlds, scriptedProvider } = await import('./lib/payment-world.mjs');
const paymentWorld = paymentWorlds({ adminUrl: ADMIN, later });
