...
const envelopeHeaders = (id, name) => ({ eventId: id, occurredAt: new Date().toISOString(), source: 'validation', version: 1, correlationId: `corr-${id.slice(0, 8)}` });
...
async function kitWorld({ publisherUrl = rabbit.url, confirmTimeoutMs, consumers = 1, retry, subscribe = true, onNotice } = {}) {
